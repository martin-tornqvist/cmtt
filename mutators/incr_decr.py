...
def mutate(lines, line_nr, rng):
    ...
    # Don't apply this mutator on lines with for loops, it would create too
    # many useless mutations
    loop_re_str = r'for.*\('

    loop_match_list = common.match_list(loop_re_str, line)

    if not loop_match_list:
